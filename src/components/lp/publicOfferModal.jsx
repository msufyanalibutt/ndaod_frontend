...
import { Form, FormGroup, FormLabel, Modal, ModalBody, FormControl, Spinner, Row, Col } from 'react-bootstrap';
...
const PublicModalOffer = ({
    ...
    const getInfo = async () => {
        try {
            ...
            let allowance = await contract.allowance(account, ShopLp_contract_address);
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <FormGroup className='mb-3'>
                            ...
                            />
                            {
                                (touched.lpAmount && errors.lpAmount) ?
                                    ...
                                    <small className="text-muted">Enter LP amount you want to buy</small>
                            }
                        ...
                        <FormGroup className='mb-3'>
                            ...
                            <FormControl
                                ...
                                disabled={!approved}
                            />
                            <small className="text-danger">{touched.targetAmount && errors.targetAmount}</small>
                        </FormGroup>
                        <FormGroup>
                            {
                                approved ?
                                    <button
                                        ...
                                        {
                                            loading ? <Spinner animation="border" variant="primary" /> : 'Buy LP'
                                        }
                                    </button> :
