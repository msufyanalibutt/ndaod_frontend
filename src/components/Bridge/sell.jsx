        ...
        <div className='tabborder p-3'>
            <Row>
                ...
                <Col className='text-right'>
                    <p>Balance: {Number(maxBalance).toFixed(4)} <span
            ...
            <Row>
                    ...
                    <p className='p-0 m-0 py-1'>
                        {
                            sellSelected && <>
                                {
                                    sellSelected.address === networks[chainId].inchCoin ? <span>{sellSelected.name}</span> : <a
                ...
                <Col>
                    ...
                    {errMsg ? <small className="text-danger">{errMsg}</small> : <small className="text-danger">{touched.fromBalance && errors.fromBalance}</small>}
                </Col>
            </Row>
        </div>
