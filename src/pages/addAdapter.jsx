...
const AddAdapter = () => {
    ...
    const createForIface = (a) => {
        let ABI = ["function addAdapter(address a)"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("addAdapter", [a]);
        return iface
    }
                ...
                active ? <>  <Container className='my-3'>
                    <Row>
                        <Col xs={12} lg={8} className="mx-auto text-white">
                            <h2>Add Adapter</h2>
                            <p>Allows you to withdraw part of the funds from third-party smart contracts, if the LP Holder decides to leave the DAO.</p>
                                ...
                                <FormGroup className='mb-3'>
                                    ...
                                    <FormControl
                                        ...
                                        onChange={(e) => {
                                            handleChange(e);
                                            if (e.target.value) {
                                                setFieldValue('title', `Add Adapter: ${e.target.value}`);
                                            }
                                        }}
                                        onBlur={handleBlur}
