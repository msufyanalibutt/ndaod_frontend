...
const BurnGt = () => {
    ...
    const createForIface = (targetAddress, amount) => {
        let ABI = ["function burn(address to, uint256 amount)"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("burn", [targetAddress, amount]);
        return iface
    }
                                        ...
                                        <FormControl
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.value && values.amount > 0) {
                                                    setFieldValue('title', `Burn ${e.target.value} To ${values.targetAddress}`);
                                                }
                                            }}
                                            onBlur={handleBlur}
