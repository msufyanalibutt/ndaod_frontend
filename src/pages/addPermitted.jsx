                ...
                active ? <>  <Container className='my-3'>
                    <Row>
                        <Col xs={12} lg={8} className="mx-auto text-white">
                            <h2>Add Permitted</h2>
                            <p>Allows you to use any smart contract as a module, and also allows the specified address to perform any operation without voting.</p>
                                ...
                                <FormGroup className='mb-3'>
                                    ...
                                    <FormControl
                                        ...
                                        onChange={(e) => {
                                            handleChange(e);
                                            if (e.target.value) {
                                                setFieldValue('title', `Add Permitted: ${e.target.value}`);
                                            }
                                        }}
                                        onBlur={handleBlur}
