...
const FreezeGtMinting = () => {
    ...
    useEffect(() => {
        setFieldValue('title', 'Disable and Freeze GT Minting');
    }, [])
    useEffect(() => {
    ...
    const createForIface = (targetAddress) => {
        let ABI = ["function disableMinting()"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("disableMinting", []);
        return iface
    }
                            ...
                            <Col xs={12} md={8} className="mx-auto text-white">
                                ...
                                <Form onSubmit={handleSubmit}>
                                    <FormGroup>
                                        <FormControl
                                            type="text"
                                            defaultValue={"Disable and Freeze GT Minting"}
                                            readOnly
                                        />
                                    </FormGroup>
                                    <FormGroup className='mt-3'>
                                        <p>Permanently disables the ability to mint GT tokens. It will not be possible to enable the minting of GT tokens.</p>
                                        <hr />
                                    </FormGroup>
                                    ...
                                    <FormGroup>
                                        <p className='text-danger'>
                                            <AiFillWarning />&nbsp;
                                            Warning! After applying this rule, you won’t be able to change it afterwards
                                        </p>
                                    </FormGroup>
...
export default FreezeGtMinting;
