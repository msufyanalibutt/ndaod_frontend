...
const CheckPermitted = ({ address }) => {
    ...
    const getPermitted = async () => {
        try {
            ...
            const permitted = await contract.containsPermitted(PrivateExitModule_contract_address[chainId]);
    ...
    const InstallPermittedDao = async () => {
        try {
            ...
            let iface = createForIface(PrivateExitModule_contract_address[chainId])
            ...
            let body = {
                ...
                daoAddress: address,
                target: address,
                title: `Add Permitted: ${PrivateExitModule_contract_address[chainId]}`,
                description: "",
                chainId,
                value: 0,
                nonce: 0,
    ...
    const navigatePrivateExit = () => {
        navigate(`/dao/${address}/modules/privateExit`);
    }
    return (
        <>
            {
    ...
    return (
        <>
            <div className='tabborder text-center px-3 py-3'>
                ...
                <h5>Private Exit</h5>
                <p>Get a private offer burning LP for exit from DAO</p>
                <button
                    onClick={handleShow}
                    type="button"
                    ...
                    <Row>
                        <Col>
                            <div className='d-flex align-items-center text-white mb-3'>
                                ...
                                <p className='p-0 m-0' style={{ fontSize: '20px' }}>Private Exit</p>
                            </div>
                        </Col>
