...
const FreezeGtBurning = () => {
    ...
    useEffect(() => {
        setFieldValue('title', 'Disable and Freeze GT Burning')
    }, [])
    useEffect(() => {
    ...
    const createForIface = (targetAddress) => {
        let ABI = ["function disableBurning()"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("disableBurning", []);
        return iface
    }
                            ...
                            <Col xs={12} md={8} className="mx-auto text-white">
                                ...
                                <Form onSubmit={handleSubmit}>
                                    <FormGroup>
                                        <FormControl
                                            type="text"
                                            defaultValue={"Disable and Freeze GT Burning"}
                                            readOnly
                                        />
                                    </FormGroup>
                                    <FormGroup className='mt-3'>
                                        <p>Permanently disables the ability to Burn GT tokens. It will not be possible to enable the Burning of GT tokens.</p>
                                        <hr />
                                    </FormGroup>
...
export default FreezeGtBurning;
