...
const FreezeLPBurning = () => {
    ...
    useEffect(() => {
        setFieldValue('title', 'Freeze LP Burning Status: Disabled');
    }, [])
    useEffect(() => {
    ...
    const createForIface = () => {
        let ABI = ["function freezeBurningStatus()"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("freezeBurningStatus", []);
        return iface
    }
                    ...
                    <Container className='my-3'>
                        <Row>
                            <Col xs={12} md={8} className="mx-auto text-white">
                                <h2>Freeze LP Burning Status</h2>
...
export default FreezeLPBurning;
