...
const FreezeLPMinting = () => {
    ...
    useEffect(() => {
        setFieldValue('title', 'Freeze LP Minting Status: Disabled');
    }, [])
    useEffect(() => {
    ...
    const createForIface = () => {
        let ABI = ["function freezeMintingStatus()"];
        let iface = new ethers.utils.Interface(ABI);
        iface = iface.encodeFunctionData("freezeMintingStatus", []);
        return iface
    }
                    ...
                    <Container className='my-3'>
                        <Row>
                            <Col xs={12} md={8} className="mx-auto text-white">
                                <h2>Freeze LP Minting Status</h2>
...
export default FreezeLPMinting;
